...
- [x] Console output does not contain raw authentication tokens or `.env` credentials.
- [x] Application does not crash when the upstream connection drops.
- [x] Upstream connection errors are logged with structured formats.
